...
flowchart TD
    ...
    branch_dspark_compact_ragged_verify -->|"merged branch / fe67763569"| branch_dflash_compact_fixin
...
```mermaid
flowchart LR
    stack_base_dflash_compact_fixin["feat/adaptive_spec_dspark/dflash_compact<br/>7abdda0180"]
